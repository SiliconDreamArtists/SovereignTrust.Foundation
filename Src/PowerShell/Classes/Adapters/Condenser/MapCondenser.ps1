...
class MapCondenser {
    ...
    [Signal] Invoke([Signal]$Signal, [object]$Proposal, [object]$Context = $null) {
        $opSignal = [Signal]::Start("MapCondenser.Invoke", $Signal) | Select-Object -Last 1
        ...
        $resultSignal = Invoke-MapCondenser -Signal $Signal -Proposal $Proposal -Context $Context | Select-Object -Last 1
